package com.securitystack.storm.drpc;
...
import com.securitystack.storm.trident.nontransactional.FakeTweetSpout;
import com.securitystack.storm.trident.nontransactional.TridentUtility;
...
public class DistributedRPC {
	...
	public static StormTopology buildTopology(LocalDRPC drpc) {
		...
		topology.newDRPCStream("Count", drpc)
				.each(new Fields("args"), new TridentUtility.Split(),
						new Fields("Country"))
