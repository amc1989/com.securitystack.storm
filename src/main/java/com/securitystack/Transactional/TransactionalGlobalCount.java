 ...
 */
package com.securitystack.Transactional;
...
public class TransactionalGlobalCount {
    private  static final int PARTITION_TAKE_PER_BATCH = 3;
    private static final Map<Integer, List<List<Object>>> DATA = new HashMap<Integer, List<List<Object>>>() {{
    ...
    private static Map<String, Value> DATABASE = new HashMap<String, Value>();
    private  static final String GLOBAL_COUNT_KEY = "GLOBAL-COUNT";
